...
class PhotoAlbum:
    ...
    def __init__(self, pages):
        ...
        # self.photos = [['[]' for p in range(self.PHOTOS_PER_PAGE)] for _ in range(self.pages)]
    ...
    """"
        self.photos = [[' ' for p in range(self.PHOTOS_PER_PAGE)] for _ in range(self.pages)]
        # -> empty matrix) representing the album with its pages where you should put the photos
